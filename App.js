...
import StackNavigation from '../MariscosElTizoc/navigation/StackNavigation';
...
//           <Text style={{ paddingLeft:'5%' ,color: 'white', fontSize: 50, width:'100%' }}>Dirección de envío</Text>
//         </View>
//         <View style={{ justifyContent: 'center', alignItems: 'center'}}>
...
//     bottom: 0,
//     resizeMode: "cover",
//     opacity: 0.6, // Opacidad de la imagen (0 - 1)
